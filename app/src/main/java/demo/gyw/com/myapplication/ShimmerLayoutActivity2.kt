...
import demo.gyw.com.myapplication.weiget.shimmer.Shimmer
import demo.gyw.com.myapplication.weiget.shimmer.ShimmerFrameLayout
import kotlinx.android.synthetic.main.activity_shimmer_layout2.*

class ShimmerLayoutActivity2 : AppCompatActivity(), View.OnClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_shimmer_layout2)
        ...
        presetButtons.forEach { it.setOnClickListener(this@ShimmerLayoutActivity2) }
