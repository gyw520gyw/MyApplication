...
//            RelativeLayout
    ...
    private fun initData() {
        this.pageModels.add(PageModel(R.layout.sample_ripple_view, R.string.title_hencode_9, R.layout.sample_ripple_view))
        this.pageModels.add(PageModel(R.layout.sample_water_wave_view, R.string.title_hencode_8, R.layout.sample_water_wave_view))
